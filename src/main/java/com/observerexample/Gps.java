...
public class Gps implements Observable {
        ...
        private int precision;// Précision accordé à cette position (suivant le nombre de satellites
                              // utilisés).
        ...
        // Méthode permettant de notifier tous les observateurs lors d'un changement
        // d'état du GPS.
        ...
        // Méthode "tiré" donc c'est aux observeurs d'aller chercher les valeurs désiré
        // grâce à un objet Gps.
